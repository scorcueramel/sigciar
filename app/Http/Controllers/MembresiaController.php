<?php
	...
	class MembresiaController extends Controller
	{
		...
		public function getMembersByPrograms(string $sedeid, string $lugarid, string $programaid){
			$detailsMemebers = DB::select("select ins.id, se.descripcion as sede , l.descripcion as lugar,
																					...
																					from servicio_inscripcions ins
																					         ...
																					         left join lugars l on s.lugar_id = l.id
																					         left join sedes se on s.sede_id =  se.id
																					where s.sede_id= ? and s.lugar_id= ? and s.id = ?",[$sedeid,$lugarid,$programaid]);
			return response()->json($detailsMemebers);
		}
