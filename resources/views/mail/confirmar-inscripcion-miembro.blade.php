...
<table role="presentation"
  ...
  <tr>
    <td align="center" style="padding:0 0 20px 0;color:#153643;" colspan="2" align="center">
      <img src="https://img.icons8.com/ios-filled/100/40C057/ok--v1.png" alt="Logo Ciar"
           width="100" style="height:auto;display:block;"/>
    </td>
  </tr>
  <tr>
    <td style="padding:0 0 15px 0;color:#153643;" colspan="2" align="center">
  ...
  <tr>
    <td>CODIGO DE TU INSCRIPCION:</td>
    <td>INSC-{{$mailConfirmacion->registro_id}}</td>
  </tr>
  <tr>
    <td>SEDE:</td>
  ...
  <tr>
    <td>
      <table>
        ...
        <tbody>
        @foreach(json_decode($mailConfirmacion->fechas_definidas) as $horario)
          <tr>
            <td>
              {{$horario->dias}}
            </td>
