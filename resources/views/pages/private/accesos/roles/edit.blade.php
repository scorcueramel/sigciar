@extends('layouts.private.private', ['activePage' => 'roles.edit'])
@push('title', 'Roles Editar')
@push('css')
<style>
    .tarjeta {
        min-height: 19rem;
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <!-- Notifications -->
            <div class="card-body">
                {!! Form::open(['route' => ['roles.update',$role->id], 'method' => 'PUT', 'class'=>'onsubmit']) !!}
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="nombrerol" value="{{$role->name}}" required>
                        @error('nombrerol')
                ...
                <div class="row mt-4 mx-1">
                    <div class="col-sm-12 p-3 border rounded">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="todos">
                ...
                <div class="row mt-4">
                        ...
                        <div class="card text-white mb-3 tarjeta">
                            ...
                            <div class="card-body tarjeta__cuerpo">
                                ...
                                <div class="form-check form-switch">
                                    ...
                                    <label class="form-check-label" for="{{$permiso->name}}">{{ strtoupper(str_replace('.dashboard', '', $permiso->name)) }}</label>
                                </div>
                                @endif
                                @endforeach
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        <div class="card text-white mb-3 tarjeta">
                            ...
                            <div class="card-body tarjeta__cuerpo">
                                ...
                                <div class="form-check form-switch">
                                    <input class="name form-check-input checkpermiso" type="checkbox" role="switch" id="{{$permiso->name}}" name="permission[]" value="{{$permiso->id}}" {{ in_array($permiso->id, $rolePermission) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="{{$permiso->name}}">{{ strtoupper(str_replace('.sedes', '', $permiso->name)) }}</label>
                                </div>
                                @endif
                                @endforeach
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        <div class="card text-white mb-3 tarjeta">
                            ...
                            <div class="card-body tarjeta__cuerpo">
                                ...
                                <div class="form-check form-switch">
                                    <input class="name form-check-input checkpermiso" type="checkbox" role="switch" id="{{$permiso->name}}" name="permission[]" value="{{$permiso->id}}" {{ in_array($permiso->id, $rolePermission) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="{{$permiso->name}}">{{ strtoupper(str_replace('.lugares', '', $permiso->name)) }}</label>
                                </div>
                                @endif
                                @endforeach
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        <div class="card text-white mb-3 tarjeta">
                            ...
                            <div class="card-body tarjeta__cuerpo">
                                ...
                                <div class="form-check form-switch">
                                    <input class="name form-check-input checkpermiso" type="checkbox" role="switch" id="{{$permiso->name}}" name="permission[]" value="{{$permiso->id}}" {{ in_array($permiso->id, $rolePermission) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="{{$permiso->name}}">{{ strtoupper(str_replace('.tenis', '', $permiso->name)) }}</label>
                                </div>
                                @endif
                                @endforeach
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        <div class="card text-white mb-3 tarjeta">
                            <div class="card-header tarjeta__cabecera">{{Str::upper('Nutrición')}}</div>
                            <div class="card-body tarjeta__cuerpo">
                                @foreach ($permisos as $permiso)
                                @if (Str::contains($permiso->name,'.nutricion'))
                                <div class="form-check form-switch">
                                    <input class="name form-check-input checkpermiso" type="checkbox" role="switch" id="{{$permiso->name}}" name="permission[]" value="{{$permiso->id}}" {{ in_array($permiso->id, $rolePermission) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="{{$permiso->name}}">{{ strtoupper(str_replace('.nutricion', '', $permiso->name)) }}</label>
                                </div>
                                @endif
                                @endforeach
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        <div class="card text-white mb-3 tarjeta">
                            <div class="card-header tarjeta__cabecera">{{Str::upper('Otros Programas')}}</div>
                            <div class="card-body tarjeta__cuerpo">
                                @foreach ($permisos as $permiso)
                                @if (Str::contains($permiso->name,'.otrosprogramas'))
                                <div class="form-check form-switch">
                                    <input class="name form-check-input checkpermiso" type="checkbox" role="switch" id="{{$permiso->name}}" name="permission[]" value="{{$permiso->id}}" {{ in_array($permiso->id, $rolePermission) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="{{$permiso->name}}">{{ strtoupper(str_replace('.otrosprogramas', '', $permiso->name)) }}</label>
                                </div>
                                @endif
                                @endforeach
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        <div class="card text-white mb-3 tarjeta">
                            ...
                            <div class="card-body tarjeta__cuerpo">
                                ...
                                <div class="form-check form-switch">
                                    <input class="name form-check-input checkpermiso" type="checkbox" role="switch" id="{{$permiso->name}}" name="permission[]" value="{{$permiso->id}}" {{ in_array($permiso->id, $rolePermission) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="{{$permiso->name}}">{{ strtoupper(str_replace('.inscripciones', '', $permiso->name)) }}</label>
                                </div>
                                @endif
                                @endforeach
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        <div class="card text-white mb-3 tarjeta">
                            ...
                            <div class="card-body tarjeta__cuerpo">
                                ...
                                <div class="form-check form-switch">
                                    <input class="name form-check-input checkpermiso" type="checkbox" role="switch" id="{{$permiso->name}}" name="permission[]" value="{{$permiso->id}}" {{ in_array($permiso->id, $rolePermission) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="{{$permiso->name}}">{{ strtoupper(str_replace('.categorias', '', $permiso->name)) }}</label>
                                </div>
                                @endif
                                @endforeach
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        <div class="card text-white mb-3 tarjeta">
                            ...
                            <div class="card-body tarjeta__cuerpo">
                                ...
                                <div class="form-check form-switch">
                                    <input class="name form-check-input checkpermiso" type="checkbox" role="switch" id="{{$permiso->name}}" name="permission[]" value="{{$permiso->id}}" {{ in_array($permiso->id, $rolePermission) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="{{$permiso->name}}">{{ strtoupper(str_replace('.noticias', '', $permiso->name)) }}</label>
                                </div>
                                @endif
                                @endforeach
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        <div class="card text-white mb-3 tarjeta">
                            ...
                            <div class="card-body tarjeta__cuerpo">
                                ...
                                <div class="form-check form-switch">
                                    <input class="name form-check-input checkpermiso" type="checkbox" role="switch" id="{{$permiso->name}}" name="permission[]" value="{{$permiso->id}}" {{ in_array($permiso->id, $rolePermission) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="{{$permiso->name}}">{{ strtoupper(str_replace('.roles', '', $permiso->name)) }}</label>
                                </div>
                                @endif
                                @endforeach
                            </div>
                    ...
                    <div class="row">
                        <div class="mt-4">
                            ...
                            <a href="{{route('roles.index')}}" role="button" class="btn btn-outline-danger">Cancelar</a>
                        </div>
                    </div>
                </div>
                {!! Form::close() !!}
...
<script>
    $(document).ready(function() {
        ...
        if ($('.checkpermiso:checked').length == permisos.length) {
        ...
        permisos.on('click', function() {
            if ($('.checkpermiso:checked').length == permisos.length) {
                ...
                console.log(permisos.length, $('.checkpermiso:checked').length);
                $('#todos').prop('checked', false);
            }
        });
    });
