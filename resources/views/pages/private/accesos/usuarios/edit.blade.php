                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select id="tipodocumento" class="select2 form-select" name="tipodocumento">
                                    ...
                                    @foreach($tipodocumentos as $td)
                                        <option
                                            value="{{$td->id}}" {{$usuario->tipodocumento_id == $td->id ? 'selected' : ''}}>{{$td->descripcion}}
...
@push('js')
    <script>
        $(document).ready(function () {
            ...
            usuarioImagen.imagen == null ? imgContent.attr('src', rutaImgDefault) : imgContent.attr('src', rutaImgStorage);
