                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" id="subtitulo" class="form-control @error('subtitulo') is-invalid @enderror" aria-label="Nombre para la subtitulo" aria-describedby="subtitulo2" name="subtitulo" value="{{old('subtitulo')}}" maxlength="100" autofocus required />
                                        @error('subtitulo')
                                        <span class="invalid-feedback d-block" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
