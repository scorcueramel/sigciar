                        ...
                        <form enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-lg-7">
                                    <div class="row mb-3">
                                        <div class="col-sm-12">
                                            <label for="actividades">Seleccionar un Programa</label>
                                            <select class="form-select" aria-label="Seleccionar actividad"
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-12">
                                            <label for="actividades">Seleccionar una Categoría</label>
                                            <select class="form-select" aria-label="Seleccionar categoria"
                                                    id="categoria" name="categoria" disabled>
                                                <option value="" selected disabled>SELECCIONAR</option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-3">
                                <input type="button" class="btn btn-primary btn-sm" id="guardarRegistro"
                                       value="Inscribir"/>
                            </div>
                        </form>
                    </div>
