                          ...
                          <tr>
                            <td>
                              <div class="form-check">
                                <input class="form-check-input actividad" type="radio" name="actividadid"
                                       id="servid{{$actividad->id}}" data-id="{{$actividad->id}}">
                              </div>
                            </td>
                            ...
                            <td><label
                                for="servid{{$actividad->id}}">{{date("d/m/Y", strtotime($actividad->inicio))}}</label>
                            </td>
                            <td><label
                                for="servid{{$actividad->id}}">{{date("d/m/Y", strtotime($actividad->fin))}}</label>
                            </td>
                          </tr>
                        @endforeach
                        </tbody>
                    ...
                    <div class="col-sm-6">
                      <div class="input-group input-group-merge">
                        ...
                        <input type="number" id="documentomiembro"
                               ...
                               aria-label="Nombre para los documentomiembro" aria-describedby="documentomiembro2"
                  ...
                  <div class="row mb-3">
                    <div class="col-sm-12">
                      ...
                      <div class="input-group input-group-merge">
                        ...
                        <input type="text" id="miembro" class="form-control ps-3 @error('miembro') is-invalid @enderror"
                    ...
                    <div class="col-md-6 mb-3 d-flex justify-content-between">
                      ...
                      <div class="col-sm-8">
                        <div class="input-group input-group-merge">
                          ...
                          <select class="form-select" id="diasInscripcion" aria-label="diasInscripcion"
...
`);
    ...
    $("#guardarRegistro").on("click", function () {
      ...
      if (documento == null || documento == '') {
        ...
        $.ajax({
          method: 'POST',
          url: "{{route('inscripciones.store.temporal')}}",
          data: {
            idservicio,
            idmiembro,
            fechasDefinidas,
          ...
          error: function (err) {
            Swal.fire({
              icon: "error",
              title: "Oops...",
              html: `<p style="color:red">Comunicate con tu área de soporte</p>${err.responseJSON.message}  `,
            });
