                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <select class="form-select" id="categoria" aria-label="categoria"
                                                    ...
                                                    @foreach ($subtiposervicios as $subtiposervicio)
                                                    <option value="{{ $subtiposervicio->id }}">{{ $subtiposervicio->titulo }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <span class="text-danger d-none subtipoServidio" role="alert">
                                                <span class="msjSubtipoServidio"></span>
                                            </span>
                                        </div>
                                    </div>
                                    <!-- end -->
