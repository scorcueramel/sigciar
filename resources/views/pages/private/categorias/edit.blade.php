    ...
    <div class="row mb-3">
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="{{route('categorias.update',$categoria->id)}}" enctype="multipart/form-data" class="row g-3 needs-validation"
                          novalidate>
                        @csrf
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    <span id="nombre2" class="input-group-text"><i
                                            class="fa-regular fa-layer-group"></i></span>
                                    <input type="text" id="nombre"
                                           class="form-control @error('nombre') is-invalid @enderror"
                                           placeholder="Nombre para la categoría" aria-label="Nombre para la sede"
                                           aria-describedby="nombre2" name="nombre"
                                           value="{{old('nombre') ?? $categoria->nombre}}" maxlength="100" autofocus
                                           required/>
                                    @error('nombre')
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" id="slug"
                                           ...
                                           placeholder="Slug de la categoría" aria-label="Slug de la categoría"
                                           aria-describedby="slug2" name="slug"
                                           value="{{old('slug') ?? $categoria->slug}}" maxlength="150" autofocus
                                           required/>
                                    @error('slug')
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="col-sm-10">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="estado" id="publciado"
                                           value="A" {{ $categoria->estado == 'A' ? 'checked' : '' }}>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="estado" id="despublicado"
                                           value="I" {{$categoria->estado == 'I' ? 'checked' : ''}}>
