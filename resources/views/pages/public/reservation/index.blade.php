    ...
    <div class="row pt-4 pb-3 d-flex justify-content-center">
        <div class="col-md-10 options">
            <div class="row pb-4 align-items-center">
                <div class="col-md-6">
                    <label for="sede" class="descripcion"><i class="fa-solid fa-buildings"></i> Seleccione la Sede:</label>
                </div>
                <div class="col-md-6">
                    <select class="form-select border-secondary shadow-sm" id="sede" name="sede" onfocus="this.blur()">
            ...
            <div class="row">
                <div class="col-md-6">
                    <label for="lugar" class="descripcion"><i class="fa-solid fa-court-sport"></i> Seleccione la Cancha:</label>
                </div>
                <div class="col-md-6">
                    <select class="form-select border-secondary shadow-sm" id="lugar" name="lugar" onfocus="this.blur()" disabled>
