      ...
      <div class="row justify-content-center align-items-center">
        <div class="col-11 col-md-5 text-start ps-5">
          ...
          {{--<h3 class="mainColor fw-bold altas">Horario</h3>
              ...
              @endforeach--}}
          <ul class="beneficios">
            <li>Una vez por semana (4 clases al mes) S/.200</li>
            <li>Dos veces por semana (8 clases al mes) S/.320</li>
            <li>Tres veces por semana (12 clases al mes) S/.440</li>
            <li>Cuatro veces por semana (16 clases al mes) S/.580</li>
            <li>Cinco veces por semana (20 clases al mes) S/.720</li>
          </ul>
        </div>
...
`);
    ...
    function calcularTotales() {
      ...
      if (totalHorarios.length == 0) {
        montoTotal = 0;
        $("#btnInscribete").attr("disabled");
        $("#btnInscribete").addClass("d-none");
      }
      if (totalHorarios.length == 1) {
        montoTotal = 200;
      }
      if (totalHorarios.length == 2) {
        montoTotal = 320;
      }
      if (totalHorarios.length == 3) {
        montoTotal = 440;
      }
      if (totalHorarios.length == 4) {
        montoTotal = 580;
      }
      if (totalHorarios.length == 5) {
        montoTotal = 720;
      }
      $('.totalPagar').html('');
      $('.totalPagar').append(`
    ...
    $("#btn-add-hour").on("click", function () {
      ...
      if ((totalHorarios.length + 1) > 5) {
        messagesInfo('<strong>Lo sentimos</strong>', 'warning',
          `<p>Solo puedesn seleccionar <strong>5 veces por semana</strong> como máximo</p>`,
          `Entiendo`);
        return;
      }
