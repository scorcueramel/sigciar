    ...
    <div class="container">
      ...
      @if (count($promesas) > 0)
        <div class="row padding2">
          <h2 class="titulo mainColor altas fw-bold mt-5 mb-4" style="margin-bottom: 25px !important;">Apoyemos a
            jóvenes promesas</h2>
                ...
                <div class="contenedor-item">
                  ...
                  <div class="overlay-item text-start">
                    <div class="info-item py-3 px-3">
                      ...
                      <div class="edades altas">{{$promesa->edad}}<a
                          href="{{route('landing.promises.details',$promesa->id)}}" class="enlace"><img
                            src="{{asset('assets/images/link.svg')}}"/></a></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="contenedor-item">
                ...
                <div class="overlay-item text-start">
                  <div class="info-item py-3 px-3">
                    ...
                    <div class="edades altas">11 años<a href="promesa-1.php" class="enlace"><img src="images/link.svg"/></a>
                    </div>
                  </div>
                </div>
              </div>
