                        ...
                        <div class="accordion accordion-flush my-3" id="accordionFlushExample">
                          <div class="row mb-4">
                            <div class="col-12 d-grid gap-2">
                              <button class="btn btn-sm btn-outline-primary" id="historiaMisReservas"
                                      data-id-usuario="{{Auth::user()->id}}">Historial
                              </button>
                            </div>
                          </div>
                          @foreach($programas as $programa)
                                    ...
                                    <div class="row d-flex align-items-center">
                                      <table class="table table-sm">
                                        ...
                                        <tr style="font-size:12px">
                                          ...
                                          <td>
                                            <button class="btn btn-sm btn-outline-danger btnQuitarReserva"
                                                    data-id-servicioid="{{$programa->servicios_id}}">Ocultar
                                            </button>
                                          </td>
                                        </tr>
                                        </tbody>
                                          ...
                                          <div class="row">
                                            <div class="col-12 d-flex justify-content-end">
                                              <button type="button" class="btn btn-sm btn-success mx-1"
                                                      onclick="javascript:editarNotaModal({{$programa->id}});"
                                                      ddata-toggle="tooltip" data-placement="top" title="Editar Nota"><i
                                                  class="fa-solid fa-file-pen"></i></button>
                                              <button type="button" class="btn btn-sm btn-danger"
                                                      onclick="javascript:eliminarNota({{$programa->id}});"
                                                      ddata-toggle="tooltip" data-placement="top"
                                                      title="Editar Eliminar"><i class="fa-solid fa-trash"></i></button>
                                            </div>
                                          </div>
                                        </div>
                                      </div>
