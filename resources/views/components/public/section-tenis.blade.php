    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12 col-md-8">
                <h2 class="titulo mainColor altas fw-bold mb-4" data-aos="fade-up" data-aos-duration="1000">¡Entrena
                    tenis hoy!</h2>
                        ...
                        <div class="swiper-slide col-12 col-md-4 py-4">
                            <div class="item-actividades position-relative">
                                <div class="contenedor-item">
                                    <figure class="imagen-item">
                                        <a href="#">
                                            <img src="{{asset('assets/images/actividades/tenis-pequenos.webp')}}"
                                                 class="w-100"/>
                                        </a>
                                    </figure>
                        ...
                        <div class="swiper-slide col-12 col-md-4 py-4">
                            <div class="item-actividades position-relative">
                                <div class="contenedor-item">
                                    <figure class="imagen-item">
                                        <a href="#">
                                            <img src="{{asset('assets/images/actividades/tenis-ninos.webp')}}"
                                                 class="w-100"/>
                                        </a>
                                    </figure>
                        ...
                        <div class="swiper-slide col-12 col-md-4 py-4">
                            <div class="item-actividades position-relative">
                                <div class="contenedor-item">
                                    <figure class="imagen-item">
                                        <a href="#">
                                            <img src="{{asset('assets/images/actividades/tenis-jovenes.webp')}}"
                                                 class="w-100"/>
                                        </a>
                                    </figure>
                        ...
                        <div class="swiper-slide col-12 col-md-4 py-4">
                            <div class="item-actividades position-relative">
                                <div class="contenedor-item">
                                    <figure class="imagen-item">
                                        <a href="#">
                                            <img src="{{asset('assets/images/actividades/tenis-adultos.webp')}}"
                                                 class="w-100"/>
                                        </a>
                                    </figure>
                        ...
                        <div class="swiper-slide col-12 col-md-4 py-4">
                            <div class="item-actividades position-relative">
                                <div class="contenedor-item">
                                    <figure class="imagen-item">
                                        <a href="#">
                                            <img src="{{asset('assets/images/actividades/tenis-familias.webp')}}"
                                                 class="w-100"/>
                                        </a>
                                    </figure>
