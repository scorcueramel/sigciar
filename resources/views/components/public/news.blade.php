<section class="noticias padding" id="noticias">
    <div class="container">
        ...
        <div class="justify-content-center">
            <a class="btn-cta altas" href="noticias.php" data-aos="fade-up" data-aos-duration="1000"><img src="{{asset('assets/images/arrow-bt.svg')}}" class="icon me-2 me-lg-1" /> Más noticias</a>
        </div>
    </div>
</section>
