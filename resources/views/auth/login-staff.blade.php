...
@section('content')
    <div class="content">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="{{ asset('assets/images/ciar-logo.jpg') }}" alt="Image" class="img-fluid">
                </div>
                <div class="col-md-6 contents">
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="mb-4">
                                <h3>Bienvenido | <strong>CIAR</strong></h3>
                                <p class="mb-4">Centro Internacional de Alto Rendimiento</p>
                            </div>
                            ...
                            @endif
                            <form action="{{ route('login.staff') }}" method="post" autocomplete="off" id="login">
                                @csrf
                                ...
                                <div class="d-flex mb-5 align-items-center">
                                    ...
                                    {{--
                                    <label class="control mb-0"><span class="caption">{{ __('Recordar') }}</span>
