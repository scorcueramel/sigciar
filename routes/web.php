...
// Route::get('/ciar/servicio/{sede}/{lugar}', [ReservationController::class, 'test'])->name('reservas.obtener');
	...
	Route::group(['prefix' => 'ciar'], function () {
		...
		//Reservas con niubiz
		Route::post('/genera/token/niubiz', [ReservationController::class, 'generateSessionToken'])->name('genera.token.niubiz');
		Route::post('/intento/pago/cliente', [ReservationController::class, 'attemptClientPay'])->name('attempt.client.pay');
...
// Rutas para el Administrador
	Route::group(['middleware' => 'isNotUser', 'prefix' => 'admin'], function () {
		...
		Route::get('/notificar/{id}/membresia', [MembresiaController::class, 'sendNotification'])->name('notificacion.membresia');
